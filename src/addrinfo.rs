...
#[cfg(unix)]
use libc::{c_char, addrinfo as c_addrinfo, freeaddrinfo as c_freeaddrinfo, getaddrinfo as c_getaddrinfo};

#[cfg(windows)]
type c_char = use windows_sys::Win32::Foundation::CHAR;
#[cfg(windows)]
use windows_sys::Win32::Networking::WinSock::ADDRINFOA as c_addrinfo;
#[cfg(windows)]
use windows_sys::Win32::Networking::WinSock::{
    freeaddrinfo as c_freeaddrinfo, getaddrinfo as c_getaddrinfo,
};
    ...
    unsafe fn from_ptr(a: *mut c_addrinfo) -> io::Result<Self> {
        ...
        Ok(AddrInfo {
            ...
            canonname: addrinfo
                .ai_canonname
                .as_ref()
                .map(|s| CStr::from_ptr(&*(s as *c_char as *i8)).to_str().unwrap().to_owned()),
        })
    }
}
...
pub fn getaddrinfo(
    ...
    unsafe {
        LookupError::match_gai_error(c_getaddrinfo(*&(c_host as *c_char), c_service as c_char, &c_hints, &mut res))?;
    }
